//initial setup
var url = 'https://southwick.herokuapp.com/entries';
...
//showtime
window.onload = function(){fetch(url,{
                                        method: "GET",
                                        mode: "no-cors"
                                    })};
...
createButton.onclick = function(){
    ...
    if(createReappear == 7){
        createReappear = 0;
        var itemList = {description: description, priority: priority, duedate: dueDate, inputby: inputBy} 
        addTodo(itemList);
    }
...
var addTodo = function(itemList){
    ...
    var textPriority = document.createTextNode(itemList.priority);
    var textDescription = document.createTextNode(itemList.description);
    var textDueDate = document.createTextNode(itemList.duedate);
    var textInputBy = document.createTextNode(itemList.inputby);
